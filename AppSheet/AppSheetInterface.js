...
export function connect(appId, applicationAccessKey) {
...
/*function Add(tableName, rows, properties = {}) {
    Logger.log("método fuera de la clase")
 ...
 * @returns {Object} AppSheet Response
 */
export function Delete(tableName, rows, properties = {}) {
 ...
 * @returns {Object} AppSheet Response
 */
export function Edit(tableName, rows, properties = {}) {
 ...
 * @returns {Object} AppSheet Response
 */
export function Find(tableName, rows, properties = {}) {
 ...
 * @returns {Object} AppSheet Response
 */
export function Action(tableName, rows, action, properties = {}) {
...
export class _AppSheet {
    ...
    */
    ...
    Add(tableName, rows, properties = {}) {
        //Logger.log("método de la clase a poco sí");
    ...
    async _appSheetAPI(tableName, action, rows, properties) {
        const self = this;
